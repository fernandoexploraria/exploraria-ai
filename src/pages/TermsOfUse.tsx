          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <div className="bg-card p-4 sm:p-6 rounded-lg border border-border">
              ...
              <div className="space-y-4 sm:space-y-6 text-sm leading-relaxed text-muted-foreground">
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">a. Scope of License:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">b. Consent to Use of Data:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">c. Termination:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">d. External Services:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">e. NO WARRANTY:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">f. Limitation of Liability:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">g. Export Control:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">h. Government End Users:</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-foreground">i. Governing Law:</h3>
                  <p>
