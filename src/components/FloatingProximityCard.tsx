...
const FloatingProximityCard: React.FC<FloatingProximityCardProps> = React.memo(({
  ...
  if (selectedService) {
    ...
    return (
      <Card 
        className="fixed bottom-4 right-4 w-[320px] min-w-[320px] max-w-[320px] min-w-0 shrink-0 max-h-96 bg-gray-900 backdrop-blur-sm shadow-xl border border-gray-700 z-50 overflow-x-hidden transform-gpu touch-manipulation select-none will-change-auto"
