...
const DebugWindow: React.FC<DebugWindowProps> = ({ isVisible, onClose }) => {
  ...
  return (
    <div className="fixed inset-4 md:top-4 md:right-4 md:left-auto md:bottom-auto md:w-96 bg-black/90 text-white rounded-lg shadow-2xl !z-[99999] max-h-[80vh] md:max-h-[80vh] overflow-auto">
